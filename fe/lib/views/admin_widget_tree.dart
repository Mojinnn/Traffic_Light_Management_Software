...
import 'package:first_flutter/views/pages/admin/admin_profile.dart';
...
import 'package:first_flutter/views/pages/admin/admin_home.dart';
...
List<Widget> pages = [AdminHome(), ProfilePage()];
